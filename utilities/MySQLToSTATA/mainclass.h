...
struct tableDef
{
  ...
  QString lkp_code_field;
  QString lkp_desc_field;
...
public:
    ...
    void setParameters(QString host, QString port, QString user, QString pass, QString schema, QString createXML, QString outputDir, bool protectSensitive, QString tempDir, QString encryption_key, int num_workers);
    int returnCode;
signals:
    void finished();
public slots:
...
private:
    ...
    bool is_lookup_int(QString table);
